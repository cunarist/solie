...
class StrategyBasicInput(QtWidgets.QWidget):
    def __init__(self, done_event, payload):
        ...
        red_pixmap.load("./solie/static/icon/traffic_light_red.png")
        yellow_pixmap = QtGui.QPixmap()
        yellow_pixmap.load("./solie/static/icon/traffic_light_yellow.png")
        green_pixmap = QtGui.QPixmap()
        green_pixmap.load("./solie/static/icon/traffic_light_green.png")
