...
Read the [documentation](https://cunarist.com/docs/solie) to understand how to turn on auto-trading, make your own strategies with the interal API, and get involved in Solie development.
