...
Since this is a Python project, you need to install some things on your system first. Don't worry, it won't be as hard as you think if you adhere to the following instructions.
